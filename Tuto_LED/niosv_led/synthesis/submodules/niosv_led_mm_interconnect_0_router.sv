...
module niosv_led_mm_interconnect_0_router_default_decode
  #(
...
module niosv_led_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h30060 - 64'h30050); 
    localparam PAD5 = log2ceil(64'h30068 - 64'h30060); 
    // -------------------------------------------------------
    ...
    niosv_led_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x30060 .. 0x30068 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 18'h30060   ) begin
